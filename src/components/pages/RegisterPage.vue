  ...
  <div class="register-page">
    ...
    <section class="min-h-[40vh] flex items-center justify-center relative overflow-hidden">
      ...
      <div class="container-narrow relative z-10 py-20 text-center">
        ...
        <p class="text-lg sm:text-xl text-light-muted dark:text-dark-muted mb-8 max-w-2xl mx-auto">
          Browse {{ toolsList.length }} tools with {{ totalImplementations }} implementations across {{ interfacesList.length }} interfaces.
        </p>
    ...
    <section class="py-8 border-y border-light-border dark:border-dark-border bg-light-surface/50 dark:bg-dark-surface/50">
      <div class="container-narrow">
        ...
        <div class="mt-6 p-4 rounded-lg bg-brand-primary/5 border border-brand-primary/20">
          <div class="flex items-start gap-3">
            ...
            <div class="text-sm text-light-muted dark:text-dark-muted">
              <strong class="text-light-text dark:text-dark-text">Interface → Tool → Implementation:</strong>
              An <span class="text-brand-primary">interface</span> defines the abstract API contract.
              A <span class="text-brand-primary">tool</span> implements an interface.
              Multiple <span class="text-brand-primary">implementations</span> (GNU, BusyBox, BSD) can exist for the same tool,
              each with platform-specific behavior and options.
            </div>
          </div>
        </div>
      </div>
